...
<div bind:this={mapContainer} class="relative w-full map-container sm:w-1/2">
  {#if showEventOverlay()}
...
{#if clickedCoordinates}
  <div class="absolute top-0 left-0 z-10 p-2 mt-4 ml-4 text-sm border rounded bg-gray-100/90">
